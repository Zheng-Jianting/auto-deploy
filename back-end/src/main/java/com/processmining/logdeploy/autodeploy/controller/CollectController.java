...
public class CollectController {
    ...
    public Result addDeploy(@RequestParam("file") MultipartFile file, @RequestParam("type") String type,
        ...
        Result result = collectService.addDeploy(file, type, nodeId, directory, project_id, is_execute, script, code);
    ...
    @RequiresAuthentication
    public Result addCollect(@RequestBody JSONObject jsonParam) {
